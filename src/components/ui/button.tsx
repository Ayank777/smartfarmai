  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-lg hover:shadow-xl hover:scale-105 transform font-semibold",
        harvest: "bg-gradient-secondary text-secondary-foreground shadow-md hover:shadow-lg hover:scale-105 transform font-semibold",
        earth: "bg-earth text-earth-foreground shadow-md hover:bg-earth/90 hover:shadow-lg",
      ...
      size: {
        ...
        xl: "h-16 rounded-lg px-10 text-xl font-semibold",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
